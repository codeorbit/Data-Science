...
recall_score = cross_val_score(nb_model,X_test,y_pred,cv=10,scoring='recall').mean()
#print "\n"
print "recall score : ",recall_score
  
f1_score = cross_val_score(nb_model,X_test,y_pred,cv=10,scoring='f1').mean()
#print "\n"
...
nb_model = nb_model.fit(X=body_title_tags_corpus[0:len(train_data_df)], y=train_data_df.Popularity)
test_pred = nb_model.predict(body_title_tags_corpus[len(train_data_df):])
