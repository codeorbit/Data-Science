...
accu_score = cross_val_score(svm_model,X_test,y_pred,cv=10,scoring='accuracy').mean()
print "\n"
print "accuracy score : ",accu_score  

precision_score = cross_val_score(svm_model,X_test,y_pred,cv=10,scoring='precision').mean()
#print "\n"
print "precision score : ",precision_score

recall_score = cross_val_score(svm_model,X_test,y_pred,cv=10,scoring='recall').mean()
#print "\n"
print "recall score : ",recall_score
  
f1_score = cross_val_score(svm_model,X_test,y_pred,cv=10,scoring='f1').mean()
#print "\n"
